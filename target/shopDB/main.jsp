    ...
    <td><table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
     ...
     style="HEIGHT: 90px; VISIBILITY: inherit; WIDTH: 1003px; Z-INDEX: 3"> </IFRAME>
      ...
      <table width="1003" height="620" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="212" height="220" valign="top" background="images/bg_line.gif" id="lt" style=""><div align="center">
      ...
      style="HEIGHT: 1000px; VISIBILITY: inherit; WIDTH: 212px; Z-INDEX: 2"> </IFRAME>
          ...
          <td width="778" bgcolor="#FFFFFF" id="mn"><div align="center">
              <IFRAME frameBorder=0 id=main name=main scrolling=yes src="index.jsp"
